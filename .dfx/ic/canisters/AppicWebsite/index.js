...
import { idlFactory } from './AppicWebsite.did.js';
export { idlFactory } from './AppicWebsite.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_APPICWEBSITE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AppicWebsite.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AppicWebsite canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AppicWebsite.did.js")._SERVICE>}
 */
export const AppicWebsite = createActor(canisterId);
