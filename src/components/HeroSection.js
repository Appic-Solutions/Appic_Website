const HeroSection = () => {
  ...
  <video autoPlay muted loop className="video-background"  >
    ...
    <h1 className="hero-title">AppIC Crosschain Swap on ICP</h1>
    ...
    <div className="btn-wrap">
        <a href="https://app.appic.solutions/" target="blank" className="btn btn2">Launch App</a>
        <a href="https://appic.gitbook.io/appic" target="blank" className="btn btn-two">Explore Docs</a>
    </div>
</div>
          </div>
        </div>
